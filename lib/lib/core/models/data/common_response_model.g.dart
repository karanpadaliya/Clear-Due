...
CommonResponseModel _$CommonResponseModelFromJson(Map<String, dynamic> json) =>
    CommonResponseModel(
      outOfRangeReason: (json['out_range_reason'] as List<dynamic>?)
          ?.map((e) =>
      ...
      remainingPunchInWorkReport:
          json['remaining_punch_in_work_report'] as String?,
...
Map<String, dynamic> _$CommonResponseModelToJson(
    ...
    <String, dynamic>{
      ...
      'punch_out_work_report_requirement':
          instance.punchOutWorkReportRequirement,
