...
class CircleImageEmployeeCardModel {
  final Widget? image;
  final String name, department;

  CircleImageEmployeeCardModel({
    required this.image,
    required this.name,
...
class CircleImageEmployeeCard extends StatelessWidget {
  ...
  final ValueChanged<CircleImageEmployeeCardModel>? onSelected;

  const CircleImageEmployeeCard({
    // required this.image,
    required this.name,
    required this.department,
