...
part of 'get_members_by_department_response_model.dart';
...
_$GetMembersByDepartmentResponseModelFromJson(Map<String, dynamic> json) =>
    GetMembersByDepartmentResponseModel(
      employees:
...
Map<String, dynamic> _$GetMembersByDepartmentResponseModelToJson(
  GetMembersByDepartmentResponseModel instance,
) => <String, dynamic>{
